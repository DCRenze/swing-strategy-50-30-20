"""Daily signal screener for Sleeve A only (100% of the account).
  ...
  A. three_lower_lows (100%, 10 x ~10% positions) - next-day limit buys + exit
     checks (mean reversion). Sleeve H (momentum) was retired 2026-09-24.
...
# Sleeve H (momentum) RETIRED 2026-09-24: no new entries. These constants remain only
# so run_daily can exit any H positions still open under their original rules.
